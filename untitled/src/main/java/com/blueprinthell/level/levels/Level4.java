...
public class Level4 extends AbstractLevel {
    ...
    public Level4() {
        super(4, "Level 4 - Spy Network Expansion", 99999.0);
        this.packetsPerPort = 5;
        this.maxLossRatio = 0.40;
    }

    @Override
    public String getDescription() {
        return "The spy network is growing! Manage the increased cross-traffic.";
    }
    ...
    public LevelDefinition getDefinition() {
        ...
        boxes.add(withId("L4-B13-SPY3", _b13));
        ...
        boxes.add(withId("L4-B14-SPY4", _b14));
